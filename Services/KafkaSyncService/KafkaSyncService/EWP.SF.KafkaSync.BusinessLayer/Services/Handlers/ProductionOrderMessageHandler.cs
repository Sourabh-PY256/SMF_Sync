...
{
    public class ProductionOrderMessageHandler : ISyncMessageHandler
    {
        private readonly ILogger<ProductionOrderMessageHandler> _logger;

        public ProductionOrderMessageHandler(ILogger<ProductionOrderMessageHandler> logger)
        {
            _logger = logger;
        }

        public string[] SupportedServices => new[] { SyncERPEntity.PRODUCTION_ORDER_SERVICE };
