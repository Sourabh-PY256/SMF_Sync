...
{
    public class ProductReceiptMessageHandler : ISyncMessageHandler
    {
        private readonly ILogger<ProductReceiptMessageHandler> _logger;

        public ProductReceiptMessageHandler(ILogger<ProductReceiptMessageHandler> logger)
        {
            _logger = logger;
        }

        public string[] SupportedServices => new[] { SyncERPEntity.PRODUCT_RECEIPT_SERVICE };
