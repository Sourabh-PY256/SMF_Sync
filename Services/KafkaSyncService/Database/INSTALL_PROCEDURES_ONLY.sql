-- =============================================
-- INSTALL STORED PROCEDURES FOR ORDER TRANSACTION MATERIAL
-- Database: ewp_sf_devsync
-- Description: Creates only the stored procedures (tables already exist)
-- =============================================
...
-- Description: Retrieves order transaction material data
-- =============================================
...
-- Description: Updates ExternalId after ERP sync
-- =============================================
...
-- Description: Inserts/updates order transaction material
-- =============================================
...
proc_label: BEGIN
    ...
    DECLARE _NewTransactionId VARCHAR(36);
